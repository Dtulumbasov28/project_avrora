 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".terms__slider")) new core(".terms__slider", {
                modules: [ Navigation, Pagination, Autoplay, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".gallery__photo")) new core(".gallery__photo", {
                modules: [ Navigation, Autoplay ],
                autoplay: {
                    delay: 3e3,
                    pauseOnMouseEnter: true
...
***************************************************************************** */
        ...
        function init() {
            ...
            const placemark = new ymaps.Placemark([ 55.78888941293173, 37.51802731246183 ], {}, {
        ...
        let callCheckbox = document.querySelector(".popup__checkbox-call");
        let callButton = document.querySelector(".popup__button-call");
        callCheckbox.addEventListener("click", (function() {
            callCheckbox.toggleAttribute("checked");
            callButton.toggleAttribute("disabled");
        }));
        let questionCheckbox = document.querySelector(".popup__checkbox-question");
        let questionButton = document.querySelector(".popup__button-question");
        ...
        phoneCall.addEventListener("input", (e => {
            ...
            let result;
            if (phoneCall.value.includes("+8") || "8" === phoneCall.value[0]) result = ""; else result = "+";
        ...
        phoneQuestion.addEventListener("input", (e => {
            ...
            const numberLength = 11;
            let result;
            if (phoneQuestion.value.includes("+8") || "8" === phoneQuestion.value[0]) result = ""; else result = "+";
            for (let i = 0; i < value.length && i < numberLength; i++) {
                switch (i) {
                  case 0:
                    result += prefixNumber2(value[i]);
